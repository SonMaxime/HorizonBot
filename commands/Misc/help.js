...
module.exports.run = (client, message, args, settings) => {
  if (!args.length) {
    const embed = new MessageEmbed()
      .setColor("#36393F")
      .addField(message.guild.language.listOfCommands, message.guild.language.listOfCommandsDescription + ` \`${settings.prefix}help <command_name>\`.`)
      .addFields(
        ...
        { name: 'Musique', value: `nowplaying, play, playlist, queue, remove ` + message.guild.language.et + ` skipto` },
